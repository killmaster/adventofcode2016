...
def heuristic(state):
    (x1,y1) = state.endposition
    (x2,y2) = state.position
...
def astar(problem):
    ...
    #frontier.put(currentnode,problem.initialstate)
    visited.append(problem.initialstate)
